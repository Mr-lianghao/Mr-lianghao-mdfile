...
<script type="text/javascript">
	function exitSystem1() {
		var flag = window.confirm("确认退出系统吗?");
		if (flag) {
			window.top.location.href="${pageContext.request.contextPath}/servlet/adminExit";
		}
						...
						<td width="15%">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="155" valign="center"
										background="${pageContext.request.contextPath}/admin/images/mis_05b.jpg">
										<font color="blue">
											当前用户： ${admin.adminName }</font></td>
									<td width="155" valign="center"
										background="${pageContext.request.contextPath}/admin/images/mis_05b.jpg">
										<font color="blue"><a href="javascript:void(0)"
											onclick="exitSystem1()">退出系统</a> </font></td>
